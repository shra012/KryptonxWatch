export type Category = "Robbery" | "Theft" | "Shoplifting" | "Pickpocketing" | "Gun" | "Queue tracking" | "Kiosk nonpayment" | "Medical emergency" | "Suspicious activity";
...
export interface Detection { id: string; videoId: string; seconds: number; category: Category; severity: Severity; status: ReviewStatus; description: string; box?: BoundingBox }
export interface VideoRecord { id: string; title: string; recordedAt: string; duration: number; source: "sample" | "upload"; analysis: AnalysisStatus; mediaPath?: string; blob?: Blob; size?: number; detections: Detection[] }
...
export const categories: Category[] = ["Robbery","Theft","Shoplifting","Pickpocketing","Gun","Queue tracking","Kiosk nonpayment","Medical emergency","Suspicious activity"];
