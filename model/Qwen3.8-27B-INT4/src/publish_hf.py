...
seeds under seed{1,2,3}/, results/*.json, a sample of Detection JSON, the study code and split lists.
  ...
  python model/Qwen3.8-27B-INT4/src/publish_hf.py --dry-run            # build the card in /data/runs/qwen38/hf_stage only
  python model/Qwen3.8-27B-INT4/src/publish_hf.py --repo shra012/qwen3.8-27b-ucf-shoplifting-lora
"""
...
STUDY = SRC.parent.parent / "study/v1"
...
`src/qwen_model.py`, since other prompts or frame rates were not evaluated.
