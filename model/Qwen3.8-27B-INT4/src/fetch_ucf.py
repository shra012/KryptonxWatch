...
Examples:
  python3 model/Qwen3.8-27B-INT4/src/fetch_ucf.py --classes Robbery --list
  python3 model/Qwen3.8-27B-INT4/src/fetch_ucf.py --classes Shoplifting --out /data/ucf-crime/raw
"""
...
INTERMEDIATE = Path(__file__).resolve().parent.parent.parent / "certs" / "incommon-rsa-ov-ssl-ca-3.pem"
CHUNK = 8 * 1024 * 1024
