...
background threads while the GPU scores.
  ...
  python model/src/score_windows.py --splits train --out /data/runs/qwen38/exp2/zeroshot_trainpool.csv
  python model/src/score_windows.py --splits test --adapter /data/runs/qwen38/exp3/seed1/adapter \
