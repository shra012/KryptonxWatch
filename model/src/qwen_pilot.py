"""G2 inference pilot for Qwen3.8-27B (see model/.plans/qwen3.8-27b-arm.md).
...
Uses only UCF train-split videos; labels are irrelevant here.
  ...
  ~/.venvs/qwen/bin/python model/src/qwen_pilot.py --windows 20 --out model/runs/qwen38/g2-pilot
"""
